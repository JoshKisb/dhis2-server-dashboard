...
import { Box, Button, Chip, CircularProgress, Grid, Paper, Stack, styled } from "@mui/material";
import FaceIcon from "@mui/icons-material/Face";
import { useServers } from "../../stores";
import DashboardChart from "./Chart";
import ServerConfig from "../ServerConfig";
import { useGetServerByIdQuery } from "../../services/servers";
...
const Dashboard: React.FC = () => {
   ...
   const { data: server, isLoading } = useGetServerByIdQuery(store.selected as any);
                  ...
                  <Grid item xs={12} md={10}>
                     <Item elevation={0}>
                        ...
                        >
                           ...
                           <Typography paragraph>Version: Ubuntu 20.04</Typography>
                        </Box>
                     </Item>
                  </Grid>
               </Grid>
